...
7) play - отправить запрос на игру другому игроку
8) get_game_request - посмотреть активные запросы на игру
9) remove_game_request - отклонить выбранный запрос на игру
