...
class TestKing(unittest.TestCase):
    ...
    def test_King(self):
        ...
        self.assertEqual(figure.get_possible_moves(board), ['d4', 'd5', 'd6', 'e4', 'e6', 'f4', 'f5', 'f6'])

        board[3][4] = 'Pw'
        board[4][3] = 'Pw'
        board[5][4] = 'Pw'
        board[4][5] = 'Pw'
        self.assertEqual(figure.get_possible_moves(board), ['d4', 'd6', 'f4', 'f6'])
        board[3][3] = 'Pw'
        board[5][3] = 'Pw'
        board[3][5] = 'Pw'
        board[5][5] = 'Pw'
        ...
        board[0][7] = 'Rb'
        board[7][7] = 'Rb'
        self.assertEqual(figure1.get_possible_moves(board), ['c1', 'd1', 'd2', 'e2', 'f1', 'f2', 'g1'])
        self.assertEqual(figure2.get_possible_moves(board), ['c8', 'd7', 'd8', 'e7', 'f7', 'f8', 'g8'])
        ...
        board[1][0] = 'Knw'
        board[7][0] = 'Rb'
        self.assertEqual(figure.get_possible_moves(board), ['d1', 'd2', 'e2', 'f1', 'f2'])
        board[6][0] = 'Knb'
        figure.update_possible_moves(board)
        self.assertEqual(figure.possible_moves, [(3, 0), (3, 1), (4, 1), (5, 0), (5, 1)])
...
class TestQueen(unittest.TestCase):
    ...
    def test_Queen(self):
        ...
        board = [[' ' for i in range(8)] for j in range(8)]
        self.assertEqual(figure.get_possible_moves(board), ['a1', 'a5', 'b2', 'b5', 'b8', 'c3', 'c5', 'c7', 'd4', 'd5', 'd6', 'e1', 'e2', 'e3', 'e4', 'e6', 'e7', 'e8', 'f4', 'f5', 'f6', 'g3', 'g5', 'g7', 'h2', 'h5', 'h8'])

        board[2][4] = 'Pw'
        board[4][2] = 'Pw'
        board[6][4] = 'Pw'
        board[4][6] = 'Pw'
        self.assertEqual(figure.get_possible_moves(board), ['a1', 'b2', 'b8', 'c3', 'c7', 'd4', 'd5', 'd6', 'e4', 'e6', 'f4', 'f5', 'f6', 'g3', 'g7', 'h2', 'h8'])
        board[2][2] = 'Pw'
        board[6][2] = 'Pw'
        board[2][6] = 'Pw'
        board[6][6] = 'Pw'
        ...
        board[6][4] = 'Pb'
        board[4][6] = 'Pb'
        self.assertEqual(figure.get_possible_moves(board), ['a1', 'b2', 'b8', 'c3', 'c5', 'c7', 'd4', 'd5', 'd6', 'e3', 'e4', 'e6', 'e7', 'f4', 'f5', 'f6', 'g3', 'g5', 'g7', 'h2', 'h8'])
        board[2][2] = 'Pb'
        board[6][2] = 'Pb'
        board[2][6] = 'Pb'
        board[6][6] = 'Pb'
        figure.update_possible_moves(board)
        self.assertEqual(figure.possible_moves, [(2, 2), (2, 4), (2, 6), (3, 3), (3, 4), (3, 5), (4, 2), (4, 3), (4, 5), (4, 6), (5, 3), (5, 4), (5, 5), (6, 2), (6, 4), (6, 6)])
...
class TestRook(unittest.TestCase):
    ...
    def test_Rook(self):
        ...
        board = [[' ' for i in range(8)] for j in range(8)]
        self.assertEqual(figure.get_possible_moves(board), ['a5', 'b5', 'c5', 'd5', 'e1', 'e2', 'e3', 'e4', 'e6', 'e7', 'e8', 'f5', 'g5', 'h5'])

        board[2][4] = 'Pw'
        board[4][2] = 'Pw'
        board[6][4] = 'Pw'
        board[4][6] = 'Pw'
        self.assertEqual(figure.get_possible_moves(board), ['d5', 'e4', 'e6', 'f5'])
        ...
        figure.update_possible_moves(board)
        self.assertEqual(figure.possible_moves, [(2, 4), (3, 4), (4, 2), (4, 3), (4, 5), (4, 6), (5, 4), (6, 4)])
...
class TestKnight(unittest.TestCase):
    ...
    def test_Knight(self):
        ...
        board = [[' ' for i in range(8)] for j in range(8)]
        self.assertEqual(figure.get_possible_moves(board), ['c4', 'c6', 'd3', 'd7', 'f3', 'f7', 'g4', 'g6'])
        ...
        board[6][5] = 'Pb'
        figure.update_possible_moves(board)
        self.assertEqual(figure.possible_moves, [(3, 2), (3, 6), (5, 2), (5, 6), (6, 3), (6, 5)])
...
class TestBishop(unittest.TestCase):
    ...
    def test_Bishop(self):
        ...
        board = [[' ' for i in range(8)] for j in range(8)]
        self.assertEqual(figure.get_possible_moves(board), ['a1', 'b2', 'b8', 'c3', 'c7', 'd4', 'd6', 'f4', 'f6', 'g3', 'g7', 'h2', 'h8'])
        ...
        board[6][6] = 'Pb'
        figure.update_possible_moves(board)
        self.assertEqual(figure.possible_moves, [(3, 3), (3, 5), (5, 3), (5, 5), (6, 2), (6, 6)])
...
class TestPawn(unittest.TestCase):
    ...
    def test_Pawn(self):
        ...
        self.assertEqual(figure1.possible_moves, [(3, 2), (4, 2), (4, 3), (5, 2)])
        figure2.update_possible_moves(board)
        self.assertEqual(figure2.possible_moves, [(3, 5), (4, 4), (4, 5), (5, 5)])
